...
export const InfoArray = [
    ...
    {
        id: 5,
        name: 'Reality and dreams',
        src: '05.jpg',
        short: 'Reality and dreams',
        p: [
    ...
    {
        id: 6,
        name: 'Dreams and cinema',
        src: '06.jpg',
        short: 'Dreams and cinema',
        p: [
...
export class InfoItem extends Component{
    ...
    state = {
        main: 0,
        i1: 1,
        bg1: require(`../images/info/${InfoArray[1].src}`),
        i2: 2,
        bg2: require(`../images/info/${InfoArray[2].src}`),
        i3: 3,
        bg3: require(`../images/info/${InfoArray[3].src}`),
    ...
    update() {
        ...
        this.setState({
            main : this.props.match.params.id,
            i1: arr[0],
            bg1: require(`../images/info/${InfoArray[arr[0]].src}`),
            i2: arr[1],
            bg2: require(`../images/info/${InfoArray[arr[1]].src}`),
            i3: arr[2],
            bg3: require(`../images/info/${InfoArray[arr[2]].src}`),
        })
    }
        ...
        return(
            <div className="content info_content">
                <div className="info_mainContent">
                    ...
                    {
                        InfoArray[this.state.main].p.map((p, i) => {
                            return <p key={i}>{p}</p>
                        })
                    }
                </div>
                <div className="info_otherInfo">
                    ...
                    <Link className="info_otherInfo_link" to="/info"><div className="info_other_link">View all -></div></Link>
                </div>
                            ...
                            return (
                                <div className="info_item" key={info.id} style={border}>
                                    ...
                                    <div className="info_info">
                                        ...
                                        <Link to={`/info/${info.id}`}><div className="info_link">View details -></div></Link>
                                    </div>
                                </div>
                            );
                        })

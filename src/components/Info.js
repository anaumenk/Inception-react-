...
export const InfoArray = [
    {
        ...
        name: 'Development',
        src: '00.jpg',
        short: 'Nolan had envisioned Inception as a horror film, but eventually wrote it as a heist film even though he found that "traditionally [they] are very deliberately superficial in emotional terms.',
...

    {
        ...
        name: 'Music',
        src: '04.png',
        short: 'The score for Inception was written by Hans Zimmer, who described his work as "a very electronic, dense score", filled with "nostalgia and sadness" to match Cobb\'s feelings throughout the film.',
        p1: 'The score for Inception was written by Hans Zimmer, who described his work as "a very electronic, dense score", filled with "nostalgia and sadness" to match Cobb\'s feelings throughout the film. The music was written simultaneously to filming, and features a guitar sound reminiscent of Ennio Morricone, played by Johnny Marr, former guitarist of The Smiths. Édith Piaf\'s "Non, je ne regrette rien" ("No, I Do Not Regret Anything") pointedly appears throughout the film, used to accurately time the dreams, and Zimmer reworked pieces of the song into cues of the score. A soundtrack album was released on July 11, 2010 by Reprise Records. The majority of the score was also included in high resolution 5.1 surround sound on the second disc of the 2 disc Blu-ray release[63] Hans Zimmer\'s music was nominated for an Academy Award in the Best Original Score category in 2011, losing to Trent Reznor and Atticus Ross of The Social Network.'
        ...
        return(
            <div className="content">
                <div className="info_all">
                    {
                        InfoArray.map( info => {
                            let bg = require(`../images/info/${info.src}`),
                                border = {};
                            if (info.id === InfoArray.length - 1) {
                                border = {borderBottom: 'none',};
                            }
                            return (
                                <div className="info_item" key={info.id} style={border}>
                                    <div
                                        className="info_img"
                                        style={{
                                            background: `url(${bg})`,
                                    ...
                                    <div className="info_info">
                                        <div className="info_text">
                                            ...
                                            <div className="info_short">{info.short}</div>
                                        </div>
                                        <Link to={`/:${info.id}`}><div className="info_link">View details -></div></Link>
                                    </div>
                                </div>
                            );
                        })
